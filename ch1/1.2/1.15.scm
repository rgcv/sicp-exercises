...
; In general, we must divide the angle `a` 3ⁿ times until its absolute value is
; not greater than 0.1 radians.  Therefore, the following inequality must hold:
;
;   a/3ⁿ < 0.1 .
;
; Solving for n,
...
; logarithm's due to the following property:
;
